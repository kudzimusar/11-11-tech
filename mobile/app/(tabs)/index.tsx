...
export default function HomeScreen() {
  ...
  return <Screen contentStyle={styles.screen}>
    <AppHeader />
    <CinematicHero image={media.heroStill} video={media.heroVideo} eyebrow="11-11 Tech · Technology Design & Intelligence" title="Technology that makes business work better." body="We design, build and improve the digital systems organizations depend on." footer={<View style={styles.heroActions}><ActionButton label="Start a project" detail="Tell us what needs to change" onPress={()=>router.push('/start')} /><ActionButton label="Explore capabilities" variant="surface" onPress={()=>router.push('/explore')} /></View>} />
