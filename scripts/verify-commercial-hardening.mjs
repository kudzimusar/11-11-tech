...
assert(dataHardeningMigration.includes('consume_ingress_rate_limit') && dataHardeningMigration.includes("interval '48 hours'"), 'rate limiting must be atomic and pseudonymous limiter identifiers must expire')
